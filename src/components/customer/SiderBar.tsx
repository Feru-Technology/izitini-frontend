...
const SideBar = ({ isClosed, setIsClosed, isStatic }: Isidebar) => {
    ...
    return (
        <div>
            ...
            >
                <div
                    className={`bg-gradient-to-t z-20 from-dark-blue via-middle-blue to-light-blue p-4 space-y-8 w-52 md:w-44 lg:w-64 text-gray-200 min-h-screen ${isStatic ? '' : 'fixed'
                        }`}
                >
