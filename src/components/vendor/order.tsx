                                    ...
                                    '
                                        ...
                                        <div className='mt-5 border'>
                                            ...
                                            <ul className='space-y-2 px-2 py-3 font-semibold text-base text-slate-500'>
                                                <li>Customer <span className='font-normal ml-2 text-slate-900'>{order.user.full_name}</span></li>
                                        ...
                                        {order.status === 'under_review' ?
                                            <div className='flex justify-start space-x-4 mt-4'>
                                                <button type="submit" onClick={() => updateOrderStatus(dispatch, id, 'approved')}
                                                    className='px-3 py-2 rounded-md text-white shadow-md hover:shadow-lg hover:bg-[#0e87d2] bg-[#004896] '>Accept Order</button>
                                            ...
                                            : order.status === 'approved' ?
                                                <button type="submit" onClick={() => updateOrderStatus(dispatch, id, 'shipped')}
                                                    className='mt-4 px-3 py-2 rounded-md text-white shadow-md hover:shadow-lg hover:bg-[#0e87d2] bg-[#004896] '>Start Shipping Process</button>
                                                : ''}
